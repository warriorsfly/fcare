...
class XTDiagnoseViewModel @Inject constructor(private val diagnoseApi: DiagnoseApi,
        ...
        get(){
            return diagnosisTreatment.value?.let {
                if(it.diagnosis?.diagnosisCode2.isNullOrEmpty()){
                    ...
                    return@let false
                } else if(it.diagnosis?.diagnosisCode2.equals("4-2")||it.diagnosis?.diagnosisCode2.equals("4-3")||it.diagnosis?.diagnosisCode2.equals("4-4")||it.diagnosis?.diagnosisCode2.equals("4-5")||it.diagnosis?.diagnosisCode2.equals("4-6")){
//                    when{
