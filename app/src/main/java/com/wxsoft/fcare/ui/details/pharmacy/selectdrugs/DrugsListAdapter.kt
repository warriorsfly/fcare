...
import com.wxsoft.fcare.databinding.ItemDrugListItemBinding

class DrugsListAdapter constructor(private val lifecycleOwner: LifecycleOwner, val viewModel: SelectDrugsViewModel) :
    RecyclerView.Adapter<DrugsListAdapter.ItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            lifecycleOwner = this@DrugsListAdapter.lifecycleOwner
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        ...
        val binding: ViewDataBinding =
            ItemDrugListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
