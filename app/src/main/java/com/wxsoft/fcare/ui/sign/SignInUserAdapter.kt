...
class SignInUserAdapter constructor(private val owner:LifecycleOwner, private val itemClickListener: (SignInUser) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        ...
        val binding = ItemSignInUserBinding.inflate(LayoutInflater.from(parent.context), parent, false).apply {
            lifecycleOwner=owner
        }
        return ItemViewHolder(binding,itemClickListener)
    }

    class ItemViewHolder(binding: ItemSignInUserBinding, itemClickListener: (SignInUser) -> Unit) : RecyclerView.ViewHolder(binding.root) {
